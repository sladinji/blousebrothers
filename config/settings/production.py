...
RAVEN_CONFIG = {
    ...
    'dsn': 'https://770aeeaa5cc24a3e8b16a10c328c28c5:1aca22596ba1421198ff5269032f0ffd@sentry.io/104798',
    'release': '2.0'
}
...
ALLOWED_HOSTS = env.list('DJANGO_ALLOWED_HOSTS', default=['blousebrothers.fr'])
...
STRIPE_LIVE_PUBLIC_KEY = STRIPE_PUBLISHABLE_KEY
