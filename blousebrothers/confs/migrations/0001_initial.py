# -*- coding: utf-8 -*-
# Generated by Django 1.9.7 on 2016-07-15 13:43
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('label', models.CharField(max_length=256, verbose_name='Réponse')),
                ('why', models.CharField(blank=True, max_length=256, null=True, verbose_name='Explication')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('abstract', models.TextField(max_length=140, verbose_name='Résumé')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('label', models.TextField(max_length=256, verbose_name='Enoncé')),
        ...
        migrations.AddField(
            ...
            name='items',
            field=models.ManyToManyField(to='confs.Item', verbose_name='Items'),
        ),
        migrations.AddField(
            model_name='conference',
            name='owner',
        ...
        migrations.AddField(
            model_name='conference',
            name='specialities',
            field=models.ManyToManyField(to='confs.Speciality', verbose_name='Spécialités'),
        ),
        migrations.AddField(
            model_name='answer',
            name='question',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='answers', to='confs.Question', verbose_name='Question'),
        ),
    ]
